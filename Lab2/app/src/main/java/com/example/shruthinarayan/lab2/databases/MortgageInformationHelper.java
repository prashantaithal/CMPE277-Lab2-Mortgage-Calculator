...
public class MortgageInformationHelper extends SQLiteOpenHelper {
    ...
    public void insertHome(Datafields datafields) throws Exception {
        ...
        values.put(MortgageInformation.COLUMN1_NAME_TITLE, datafields.getType());
        values.put(MortgageInformation.COLUMN2_NAME_TITLE, datafields.getAddress());
        values.put(MortgageInformation.COLUMN3_NAME_TITLE, datafields.getCity());
        values.put(MortgageInformation.COLUMN4_NAME_TITLE, datafields.getState());
        values.put(MortgageInformation.COLUMN5_NAME_TITLE, datafields.getZip());
        values.put(MortgageInformation.COLUMN6_NAME_TITLE, datafields.getPropertyprice());
        values.put(MortgageInformation.COLUMN7_NAME_TITLE, datafields.getDownpayment());
        values.put(MortgageInformation.COLUMN8_NAME_TITLE, datafields.getRate());
        values.put(MortgageInformation.COLUMN9_NAME_TITLE, datafields.getTerms());
        values.put(MortgageInformation.COLUMN10_NAME_TITLE, datafields.getMonthlyPayments());

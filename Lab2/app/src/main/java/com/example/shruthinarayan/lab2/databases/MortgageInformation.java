...
public final class MortgageInformation {
    ...
    public static final String COLUMN6_NAME_TITLE = "PROPERTYPRICE";
    ...
    public static final String COLUMN10_NAME_TITLE = "MONTHLYPAYMENT";


    public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE IF NOT EXISTS " + MortgageInformation.TABLE_NAME + " (" +
                    MortgageInformation._ID + " INTEGER PRIMARY KEY," +
